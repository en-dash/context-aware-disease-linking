...
The system obtained 0.782 and 0.809 for micro-averaged and macro-averaged F-scores respectively for the NCBI disease corpus.  % not comparable to our figures: document-level scores with non-gold spans

The best performing team in the SemEval-2014 Task 7 is UTH\_CCB \citep{zhang-et-al:2014:SemEval}, which uses an approach similar to DNorm and achieves a best strict accuracy of 0.741 for the normalization task.  % TODO: check evaluation scheme
...
For the normalization task, their system obtained a score of 0.66 for strict accuracy.  % TODO: check evaluation scheme (F-score?)
...
Their system obtained an accuracy of 0.853 on the NCBI disease corpus.  % TODO: check evaluation scheme
...
It achieves an F-score of 0.807 for normalization on the NCBI disease corpus.  % maybe mention the 0.888 accuracy instead?
